/*
	...
	Требования к безопасности: полный контроль на стороне клиента.
*/
...
sp_UpdateStatus — тестовая процедура для отправки двух нотификаций: старт и окончание дневного обновления.
...
[dbo].[tbl_UpdateDate] — тестовая таблица с данными.
*/